    ...
    <div class="row justify-content-center">
      <div class="col-md-6" id="perguntasFrequentes">
        <div class="pergunta py-2">
          ...
          >
            <p>
                Garantimos aos nossos clientes que dentro do período de 6 meses,faremos a troca do seu produto caso seja identificado algum defeito de fabricação.</p>
          </div>
        </div>
        ...
        <div class="pergunta py-2">
          <a
            ...
            >→ Caso queira adicionar alguma peça, qual o procedimento?</a
          >
          <div
            id="pergunta4"
            class="collapse"
